...
import 'package:project_app/structre/habitDialog.dart'; // Firebase Auth import
                          ...
                          return GestureDetector(
                            onLongPress: () {
                              ...
                              HabitOptionsDialog.showHabitOptionsDialog(
                                ...
                                habit.id,
                                habit['task_name'],
                                () => HabitOptionsDialog().editHabit(context,
                                    habit.id, "daily"), // Edit function
                                () => HabitOptionsDialog()
                                    .deleteHabit(context, habit.id, "daily"),
                                "daily",
                                // Delete function
                              );
                            },
