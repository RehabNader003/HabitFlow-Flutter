...
import 'package:project_app/pages/today.dart';
import 'daily_view.dart';
import 'monthly_view.dart';
import '../data_logic/saveData.dart';
import '../structre/styles.dart';
import '../structre/textField_structrue.dart';
...
class _CreateHabitScreenState extends State<UpdatePage> {
  ...
  void initState() {
    ...
    if (widget.habitData != null) {
      ...
      if (_selectedDays.isNotEmpty) {
        isOneTimeTask = false; // Adjust according to your logic
      }

      if (_selectedDates.isNotEmpty) {
        isAllDay = false; // Adjust according to your logic
      }
