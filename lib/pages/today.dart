...
import '../structre/TaskItem.dart';
import '../structre/habitDialog.dart';
...
class _TodayState extends State<Today> {
  ...
  List<DocumentSnapshot> uncompletedTasks =
      []; // New list for uncompleted tasks
            ...
            onLongPress: () {
              HabitOptionsDialog.showHabitOptionsDialog(
                ...
                () => HabitOptionsDialog().editHabit(
                    context, task.id, "daily"), // Edit for daily habit
                () => HabitOptionsDialog().deleteHabit(
                    context, task.id, "daily"), // Delete for daily habit
                "daily",
              );
            },
          ),
          ...
          TaskItem(
            ...
            onLongPress: () {
              HabitOptionsDialog.showHabitOptionsDialog(
                ...
                task['task_name'],
                () => HabitOptionsDialog().editHabit(
                    context, task.id, "monthly"), // Edit for monthly habit
                () => HabitOptionsDialog().deleteHabit(
                    context, task.id, "monthly"), // Delete for monthly habit
                "monthly",
              );
            },
          ),
          ...
          TaskItem(
            ...
            onLongPress: () {
              HabitOptionsDialog.showHabitOptionsDialog(
                ...
                () => HabitOptionsDialog().editHabit(context, completedTask.id,
                    "completeTasks"), // Edit for completed task
                () => HabitOptionsDialog().deleteHabit(
                    context,
                    completedTask.id,
                    "completeTasks"), // Delete for completed task
                "completeTasks",
              );
            },
          ),
