...
class _HomePageState extends State<HomePage> {
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Expanded(child: _buildStatCard("Total Habits", "$totalHabits", Icons.list, Colors.purple)),
                Expanded(child: _buildStatCard("Completed Habits", "$completedHabits", Icons.check_circle, Colors.green)),
              ],
            ),
          ),
          Padding(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                Expanded(child: _buildStatCard("Uncompleted Habits", "$uncompletedHabits", Icons.cancel, Colors.red)),
                Expanded(child: _buildStatCard("Completion Rate", "${completionRate.toStringAsFixed(2)}%", Icons.show_chart, Colors.orange)),
              ],
            ),
          ),
          ...
          Expanded(
            ...
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: LineChartPage(
                selectedTimeframe: _selectedTimeframe, // Pass selected timeframe parameter
  ...
  Widget _buildStatCard(String title, String value, IconData icon, Color color) {
    return Card(
      ...
      child: Padding(
        padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 10), // Reduce padding for smaller boxes
        child: Column(
          children: [
            ...
            Text(
              title,
              style: TextStyle(fontSize: 14, color: Colors.grey[800]), // Smaller title text
            ),
            SizedBox(height: 5),
            Text(
              value,
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: color), // Smaller value text
            ),
          ],
        ),
      ),
